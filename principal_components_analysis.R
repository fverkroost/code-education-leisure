...
# Function double_axis_graph via http://stackoverflow.com/questions/25727596/function-to-build-double-y-axis-graph-in-ggplot2
...
# Merge plots 1 and 2 for biplot
biplot <- plot(double_axis_graph(biplot1,biplot2)) # shows 2 y-axes and 1 x-axis
